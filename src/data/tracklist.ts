...
Seu ❤️`
  },
  {
    ...
    artist: "Black Alien",
    audioUrl: "./audio/02-como-eu-te-quero.mp3",
...
Seu 🌹`
  ...
  {
    id: 11,
    title: "BRUTAS TAMBÉM CHORAM",
    artist: "Ajuliacosta",
    audioUrl: "./audio/11-brutas-tambem-choram.mp3",
...
❤️`
  ...
  {
    id: 12,
    title: "ATÉ SOB A LUZ DO SEU OLHAR",
    artist: "Ajuliacosta",
    audioUrl: "./audio/12-ate-sob-a-luz-do-seu-olhar.mp3",
...
💛`
  },
  {
    ...
    artist: "NandaTsunami",
    audioUrl: "./audio/13-faco-acontecer.mp3",
    imageUrl: "./photos/faco-acontecer.jpeg",
    color: "#C084FC",
    letter: `Minha feiticeira,

Essa música é sobre poder pessoal — sobre mentalizaralgo e ver acontecer. E foi exatamente assim que você chegou na minha vida. Eu imaginei alguém como você tantas vezes que quando apareceu, pareceu destino.

"Não mexe com a feiticeira" — pois é, você tem uma magia que me pegou completamente. E eu não quero escapar.

Você faz acontecer. Todo dia.
